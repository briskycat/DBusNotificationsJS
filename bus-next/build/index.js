...
const serviceName = 'org.freedesktop.Notifications1';
const objectPath = '/org/freedesktop/Notifications';
const interfaceName = 'org.freedesktop.Notifications';
const bus = dbus.sessionBus();
let NotificationsInterface = _decorate(null, function (_initialize, _Interface) {
  class NotificationsInterface extends _Interface {
    constructor() {
      super(interfaceName);
      _initialize(this);
    }
  ...
  return {
    ...
    d: [{
      ...
      key: "Notify",
      value: function Notify(appName, replacesId, appIcon, summary, body, actions, hints, timeout) {
      ...
      key: "GetServerInformation",
      value: function GetServerInformation() {
      ...
      value: function NotificationClosed(id, reason) {
        return [id, reason];
      }
    }, {
      kind: "method",
      ...
      key: "ActionInvoked",
      value: function ActionInvoked(id, actionKey) {
        return [id, actionKey];
      }
    }]
  };
